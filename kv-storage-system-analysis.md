...
|
 每桶大小        
|
 12 B (8B key_hash + 4B entry_index)   
|
|
**
Hash 表总大小
...
|
|
 SRAM Bloom 未中 → DRAM Bloom 肯定 → Hash  
|
**
~200-400 ns
**
...
|
 ✅ 可行    
|
 SRAM Bloom 4MB + DRAM Hash 9.2GB           
|
 🟢 低  
|
|
...
**
|
 LBA Bitmap 移至 DRAM, SRAM 腾给 DMA            
|
 DMA 缓冲扩至 11MB, 覆盖所有极端场景         
|
|
 🔴 
**
...
**
|
 采用 Write-Through: 写入先落 SSD, DRAM 仅缓读    
|
 简化 LRU, 消除脏数据一致性问题              
|
|
